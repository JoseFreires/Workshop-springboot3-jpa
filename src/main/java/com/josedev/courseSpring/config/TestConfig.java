...
import com.josedev.courseSpring.entities.Payment;
import com.josedev.courseSpring.entities.Product;
import com.josedev.courseSpring.entities.User;
import com.josedev.courseSpring.entities.enums.OrderStatus;
import com.josedev.courseSpring.repositories.CategoryRepository;
import com.josedev.courseSpring.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		OrderItem oi2 = new OrderItem(p1, o3, 1, p3.getPrice()); 
		OrderItem oi3 = new OrderItem(p2, o3, 2, p3.getPrice()); 
		OrderItem oi4 = new OrderItem(p5, o1, 2, p5.getPrice());
